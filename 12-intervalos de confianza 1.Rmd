...
knitr::include_graphics("ci_freq.png")
```
...
$$
\textsf{Pr}\left(\bar{X}-1.96\,\frac{\sigma}{n} < \mu < \bar{X}+1.96\,\frac{\sigma}{n} \right) = 0.95\,.
$$
Por lo tanto, un intervalo de confianza para $\mu$ al 95% de confianza es:
$$
\textsf{IC}_{95\%}(\mu) = \left(\bar{X}-1.96\,\frac{\sigma}{n} ; \bar{X}+1.96\,\frac{\sigma}{n}\right) = \left( \bar{X}\pm 1.96\,\frac{\sigma}{n} \right)\,.
$$
La cantidad $1.96\,\frac{\sigma}{n}$ se denomina **margen de error**.

## Ejemplo

En el ejemplo anterior, si la confiabilidad es de $100(1-\alpha)\%$, entonces el intervalo de confianza para $\mu$ es:
$$
\textsf{IC}_{100(1-\alpha)\%}(\mu) = \left(\bar{X}-z_{1-\alpha/2}\,\frac{\sigma}{n} ; \bar{X}+z_{1-\alpha/2}\,\frac{\sigma}{n}\right) = \left( \bar{X}\pm z_{1-\alpha/2}\,\frac{\sigma}{n} \right)
$$
...
Por lo tanto, un intervalo de confianza para $\mu$ al $100(1-\alpha)\%$ de confianza es:
$$
\textsf{IC}_{100(1-\alpha)\%}(\mu) = \left(\bar{X}-z_{1-\alpha/2}\,\frac{S}{n} ; \bar{X}+z_{1-\alpha/2}\,\frac{S}{n}\right) = \left( \bar{X}\pm z_{1-\alpha/2}\,\frac{S}{n} \right)
$$
donde $z_{1-\alpha/2}$ es el percentil $100(1-\alpha/2)$ de la distribución normal estándar.
