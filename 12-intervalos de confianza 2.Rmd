...
de 95% para estimar la media poblacional de los salarios iniciales. ¿Cuál es el valor
planeado de la desviación estándar poblacional? ¿Cuán grande deberá ser la muestra si quiere que
...
**Simular 1K de muestras aleatorias** de tamaño $n=10$ de una **población Normal** con media $\mu=10$ y desviación estándar $\sigma=1$, y para cada muestra aleatoria, calcular la **estimación** y el **intervalo de confianza** para $\sigma^2$ al 95\% de confianza correspondiente. ¿Cuál es la distribución muestral de la variable pivote? ¿Qué proporción de intervalos contiene el valor de $\sigma^2$?
...
**Simular 1K de muestras aleatorias** de tamaño $n=30$ de una **población Bernoulli** con media $\pi=0.3$, y para cada muestra aleatoria, calcular la **estimación** y el **intervalo de confianza** para $\pi$ al 95\% de confianza correspondiente. ¿Cuál es la distribución muestral de la variable pivote? ¿Qué proporción de intervalos contiene el valor de $\sigma^2$?
