...
curve(expr = f(x, mu0 = 100, n = 50, xb = 92, s = 21, alpha = 0.05), lwd = 2, col = 4, from = 85, to = 100, ylim = c(0,1), xlab = expression(mu), ylab = "Potencia")
curve(expr = g(x, mu0 = 100, n = 50, xb = 92, s = 21, alpha = 0.05), lwd = 2, col = 2, add = TRUE)
```
