...
$$
F_X(x) = P(X<x) = \int_0^{x} \frac{1}{15}e^{-\frac{1}{15}u}\,du = -e^{-\frac{1}{15}u}\Big|_{0}^{x} = 1 - e^{-x/15}\,\qquad x >0\,.
$$
...
La variable aleatoria $X$ que denota las "utilidades diarias de una empresa de consultoría (en millones de pesos)" tiene la siguiente función de densidad de probabilidad:
$$
f_X(x)=\left\{
           \begin{array}{ll}
            k\,x^2, & \hbox{si $-1<x<2$;} \\
...
- Hallar la función de distribución de las utilidades.
- Calcular la probabilidad de que la empresa tenga perdidas.
- Calcular la probabilidad de que la empresa tenga ganancias.
- Calcular la probabilidad de que la empresa tenga ganancias superiores a un millón de pesos.
- Calcular los cuartiles de las utilidades.
