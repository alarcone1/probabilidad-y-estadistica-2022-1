...
¿De cuántas maneras se peude clasificar una empresa de acuerdo con su ubicación (ciudad capital, ciudad intermedia, otra ciudad), su actividad económica (servicios, comercial, industrial, mixta), y su constitución (pública, privada)? 
...
## ¿De cuántas formas se pueden seleccionar $k$ elementos de $n$, con $k<n$, si el orden sí importa y no hay repeticiones?
...
## ¿De cuántas formas se pueden seleccionar $k$ elementos de $n$, con $k<n$, si el orden sí importa y sí hay repeticiones?
...
dim(lista)
```
## ¿De cuántas formas se pueden seleccionar $k$ elementos de $n$, con $k<n$, si el orden no importa y no hay repeticiones?
